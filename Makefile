...
UNREALROOTPATH = /home/dillen/UE5/UnrealEngine-release
GAMEPROJECTFILE =/mnt/ff95e5c2-79d2-48c9-b7af-93fd8c7da4dc/IU_Jumpking/IU_Jumpking.uproject
...
TARGETS = \
	...
	UnrealServer \
	IU_Jumpking-Linux-Debug  \
	IU_Jumpking-Linux-DebugGame  \
	IU_Jumpking-Linux-Test  \
	IU_Jumpking-Linux-Shipping  \
	IU_Jumpking \
	IU_JumpkingEditor-Linux-Debug  \
	IU_JumpkingEditor-Linux-DebugGame  \
	IU_JumpkingEditor-Linux-Test  \
	IU_JumpkingEditor-Linux-Shipping  \
	IU_JumpkingEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend IU_JumpkingEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug IU_JumpkingEditor-Linux-Debug
...
IU_Jumpking-Linux-Debug:
	 $(PROJECTBUILD) IU_Jumpking Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_Jumpking-Linux-DebugGame:
	 $(PROJECTBUILD) IU_Jumpking Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_Jumpking-Linux-Test:
	 $(PROJECTBUILD) IU_Jumpking Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_Jumpking-Linux-Shipping:
	 $(PROJECTBUILD) IU_Jumpking Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_Jumpking:
	 $(PROJECTBUILD) IU_Jumpking Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_JumpkingEditor-Linux-Debug:
	 $(PROJECTBUILD) IU_JumpkingEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_JumpkingEditor-Linux-DebugGame:
	 $(PROJECTBUILD) IU_JumpkingEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_JumpkingEditor-Linux-Test:
	 $(PROJECTBUILD) IU_JumpkingEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_JumpkingEditor-Linux-Shipping:
	 $(PROJECTBUILD) IU_JumpkingEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

IU_JumpkingEditor:
	 $(PROJECTBUILD) IU_JumpkingEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
